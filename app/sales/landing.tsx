...
<fieldset className={'form-step'+(step===0?' active':'')}>
...
<fieldset className={'form-step'+(step===1?' active':'')}>
...
<fieldset className={'form-step'+(step===3?' active':'')}>
