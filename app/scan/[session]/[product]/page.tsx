...
export const metadata={title:'Garment check-in | FabriPass',description:'View a sample garment record and confirm a demo checkpoint in its shared tracking history.'};
